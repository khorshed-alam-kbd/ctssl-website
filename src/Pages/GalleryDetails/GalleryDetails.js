...
import { FaAngleDoubleUp, FaEnvelope, FaHome, FaPhoneAlt } from 'react-icons/fa';
...
const GalleryDetails = () => {
    ...
    const Office = [
        { Img: GIO0 }, { Img: GIO1 }, { Img: GIO2 }, { Img: GIO3 }, { Img: GIO4 }, { Img: GIO5 }, { Img: GIO6 }, { Img: GIO7 },
    ]
    const Archviement = [
        { Img: GIA1 }, { Img: GIA2 }, { Img: GIA3 }, { Img: GIA4 },
    ]
    const Travailing = [
        { Img: GIT1 }, { Img: GIT2 }, { Img: GIT3 }, { Img: GIT4 }, { Img: GIT5 }, { Img: GIT6 }, { Img: GIT7 }, { Img: GIT8 }, { Img: GIT9 }, { Img: GIT10 }, { Img: GIT11 }, { Img: GIT12 }
    ]
    const Recruitment = [
        { Img: GIR1 }, { Img: GIR2 }, { Img: GIR3 }, { Img: GIR4 },
    ]
    return (
        <div>
                ...
                <div className="navbar mx-auto max-w-6xl  ">
                    <div className=" navbar-center mx-auto">
                        <ul className="flex items-center text-white font-semibold gap-3">
                            < li > <Link to='/' className='hover:border-b-2  hover:border-orange-500 p-2 mx-2 flex text-2xl '><FaHome /></Link></li>

                        </ul>
                    </div>
                </div>
            </nav >
            <div ref={ref} className="hero py-8" style={{ backgroundImage: `url(${GBI})` }}>
                <div className="hero-overlay bg-opacity-60"></div>
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        <h1 className="mb-5 text-4xl font-bold uppercase">Gallery</h1>
                        <p className="mb-5 text-xl">A Jharna Trade International / <span className='text-orange-400'>Gallery</span></p>
                    </div>
                </div>
            </div>
