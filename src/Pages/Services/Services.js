...
const serviceData = [
    {
        ...
        icon: <FaFileCode className="w-12 md:w-16 h-12 md:h-16 text-red-500 relative left-[45%] lg:left-[44%] top-4" />
    },
    {
        ...
        icon: <AiOutlineDesktop className="w-12 md:w-16 h-12 md:h-16 text-red-500 relative left-[45%] lg:left-[44%] top-4" />
    },
    {
        ...
        icon: <BsBarChart className="w-12 md:w-16 h-12 md:h-16 text-red-500 relative left-[45%] lg:left-[44%] top-4" />
    },
    {
        ...
        icon: <MdOutlineDeveloperMode className="w-12 md:w-16 h-12 md:h-16 text-red-500 relative left-[45%] top-4" />
    },
    {
        ...
        icon: <SiAltiumdesigner className="w-12 md:w-16 h-12 md:h-16 text-red-500 relative left-[45%] lg:left-[44%] top-4" />
    },
    {
        ...
        icon: <SiMicrosoftsharepoint className="w-12 md:w-16 h-12 md:h-16 text-red-500 relative left-[45%] lg:left-[44%] top-4" />
    }
];
